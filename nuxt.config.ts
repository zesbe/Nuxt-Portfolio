  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'twitter:title', content: 'ZESBE | Future Technology' },
        { name: 'twitter:description', content: 'Experience the next generation of innovation. Where AI meets elegant design.' },
